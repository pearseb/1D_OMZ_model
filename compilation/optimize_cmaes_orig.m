 ...
 bgc1d_root = '/Users/DcCoy/MATLAB/NitrOMZ';
 bgc1d_wrk = '/Users/DcCoy/MATLAB/NitrOMZ/compilation/';
 %-----------------
 % Optimization names
 OptName = 'Opt_Nov_v3b_nir40k';
 OptNameLong = 'Fix oxic/phys, constant Kv, vary anoxic params., vary Ji, non-interpolated tracers (with NH4) + random noise at 0.2, 4 rates, 8-fold N2O; original (SY)range in parameter space, 40k max. ev.';
