function bgc = bgc1d_initboundary(bgc)
 ...
 case 'ETNP'
    ...
    bgc.facnar_top = 0.1;               % Bry cond. for surface facnar         (mmol/m3)
    bgc.facnar_bot = 0.01;             	% Bry cond. for deep facnar            (mmol/m3)
    bgc.facnir_top = 0.1;               % Bry cond. for surface facnir         (mmol/m3)
    bgc.facnir_bot = 0.01;             	% Bry cond. for deep facnir            (mmol/m3)
    bgc.aoo_top = 0.1;               	% Bry cond. for surface aoo         (mmol/m3)
    bgc.aoo_bot = 0.01;             	% Bry cond. for deep aoo            (mmol/m3)
    bgc.noo_top = 0.1;               	% Bry cond. for surface noo         (mmol/m3)
    bgc.noo_bot = 0.01;             	% Bry cond. for deep noo            (mmol/m3)
    bgc.aox_top = 0.1;               	% Bry cond. for surface aoo         (mmol/m3)
    bgc.aox_bot = 0.01;             	% Bry cond. for deep aoo            (mmol/m3)
    % % % % % % % Isotopes % % % % % % % % % % %
 ...
 case 'ETSP'
   %bgc.pon_flux_top = -7.5/86400*0.8*2.00;% Bry cond. for top POC Flux            (mmolN/m2/s)
    bgc.pon_flux_top = -10/86400*(22/122);      % Bry cond. for top POC Flux      (mmolN/m2/s)
    ...
    bgc.noo_top = 0.1;               	% Bry cond. for surface noo         (mmol/m3)
    bgc.noo_bot = 0.01;             	% Bry cond. for deep noo            (mmol/m3)
    bgc.aox_top = 0.1;               	% Bry cond. for surface aox         (mmol/m3)
    bgc.aox_bot = 0.01;             	% Bry cond. for deep aox            (mmol/m3)
    % % % % % % % Isotopes % % % % % % % % % % %
